...
Descripción general del problema de la evaluación automática de respuestas en lenguaje natural y su relevancia en el ámbito educativo y tecnológico.

\section{Planteamiento del problema}
Limitaciones de los enfoques actuales y oportunidad que presentan los modelos de lenguaje de gran escala.

\section{Objetivos del trabajo}
Definición de los objetivos generales y específicos del TFM.

\section{Contribuciones}
Enumeración de las principales aportaciones del trabajo.
